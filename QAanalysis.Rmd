...
plotMDS(dge_tss, label = outcome3, col=batch, main = "Clustering by plate")
...
plotMDS(dge_tss, label = outcome3, col=batch, main = "Clustering by portionanalyte")
...
plotMDS(dge_tss, label = outcome3, col=batch, main = "Clustering by samplevial")
